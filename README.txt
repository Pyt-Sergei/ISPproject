...
celery -A flaskr.tasks.celery worker --loglevel=INFO
...
!ВНИМАНИЕ!
Если вы хотите протестировать авторизацию, вам следует делать это на сайте, но не в терминале, так как данные пользователя после
